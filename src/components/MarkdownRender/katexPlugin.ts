 ...
 */
export default function katexPlugin(context: PluginContext | null): PluginInfo {
  // Viewer component may pass null context
  if (context?.eventEmitter) {
    const { eventEmitter } = context;

    // Listen for content changes to render math (Editor only)
